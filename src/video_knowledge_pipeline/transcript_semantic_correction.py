...
DOMAIN_SEMANTIC_SUSPECT_CORRECTIONS = {
    ...
    "活医保": ("佛医保", "佛山地区医疗保障沟通中可能指佛医保；仅生成候选，需音频或人工确认。"),
    "送了一外险": ("送了意外险", "保险配置对话中可能是送了意外险；仅生成候选，需音频或人工确认。"),
    "根情况来的嘛": ("根据情况来的嘛", "口语连续识别可能漏掉据字；仅生成候选，需音频或人工确认。"),
    "民亚保险": ("明亚保险", "保险经纪服务语境中可能指明亚保险；仅生成候选，需音频或人工确认。"),
